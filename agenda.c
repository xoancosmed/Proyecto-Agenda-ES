...
#include "agenda_archivos.h" // Se incluye la librería para procesar el archivo de las tareas
#include "agenda_grupos.h" // Se incluye la librería para procesar el archivo de los grupos
...
typedef struct tareaS TareaS; // Tareas
TareaS *primero = NULL;
TareaS *ultimo = NULL;
TareaS *tarea = NULL;
        ...
        do{
            ...
            switch (opc) { // Realizar tareas según opción elegida
                ...
                case ELIMINAR:
                    modif = 1;
                    salirpreg = 1;
                    EliminarTarea(); // Llamamos a la función
                    break;
                    
                case MODIFICAR:
                    modif = 1;
                    salirpreg = 1;
                    ModificarTarea(); // Llamamos a la función
                    break;
